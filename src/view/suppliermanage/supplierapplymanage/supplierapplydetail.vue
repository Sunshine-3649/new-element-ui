...
<template>
    <div class="supplierapplyadd">
        ...
        <el-form style="margin-top:20px"  label-width="125px" ref="queryForm" size="medium">
            ...
            <el-row>
                <el-form-item label="供应商性质：" required size="mini">
                    <el-row>
                        <el-col :span="4">
                            <!-- <el-radio-group @change="purchaseChange" v-model="searchParams.supplierKindCode">
                                <el-radio label="purchase">采购</el-radio>
                                <el-radio label="oneAgentSelling">一件代发</el-radio>
                            </el-radio-group> -->
                            {{ searchParams.supplierKindCode == 'purchase' ? '采购' : '一件代发' }}
                        </el-col>
                        <el-col v-show="searchParams.supplierKindCode == 'oneAgentSelling'" :span="5">
                            <el-form-item label="供应商接口ID：" required size="mini">
                                ...
                                {{ searchParams.supplierInterfaceId }}
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form-item>
            ...
            <el-row>
                <el-form-item label="供应商类型：" required size="mini">
                    <!-- <el-radio-group @change="supplierChange" v-model="searchParams.supplierTypeCode">
                        <el-radio label="internalSupplier">国内供应商</el-radio>
                        <el-radio label="overseasSupplier">海外供应商</el-radio>
                    </el-radio-group> -->
                    {{ searchParams.supplierTypeCode == 'internalSupplier' ? '国内供应商' : '海外供应商' }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item label="可见业务线：" required size="mini">
                    <el-checkbox-group disabled v-model="channel">
                        <el-checkbox v-if="channel.indexOf(data.code) > -1" v-for="(data, index) in checkListOptions" :key="index" :label="data.code">{{ data.name }}</el-checkbox>
                    </el-checkbox-group>
                    <div>
            ...
            <el-row>
                <el-form-item label="供应商名称：" required size="mini">
                    <!-- <el-input v-model="searchParams.supplierName" style="width:250px;" placeholder=""> </el-input> -->
                    {{ searchParams.supplierName }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item label="供应商简称："  size="mini">
                    <!-- <el-input v-model="searchParams.supplierShortCall" style="width:250px;" placeholder=""> </el-input> -->
                    {{ searchParams.supplierShortCall }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item label="联系人：" required size="mini">
                    <!-- <el-input v-model="searchParams.contact" style="width:250px;" placeholder=""> </el-input> -->
                    {{ searchParams.contact }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item label="联系人电话：" required size="mini">
                    <!-- <el-input @change="checkPhone('phone')" v-model="searchParams.phone" style="width:250px;" placeholder=""> </el-input> -->
                    {{ searchParams.phone }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item v-if="searchParams.supplierTypeCode == 'internalSupplier'" label="省份-城市-地区："  size="mini">
                    {{ province_city_area[0] }}-{{ province_city_area[1] }}-{{ province_city_area[2] }}
                    <!-- {{ interCity }} -->
                </el-form-item>
            ...
            <el-row>
                <el-form-item label="详细地址：" required size="mini">
                    <!-- <el-input v-model="searchParams.address" style="width:500px;" placeholder=""> </el-input> -->
                    {{ searchParams.address }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item v-if="searchParams.supplierTypeCode == 'internalSupplier'" label="证件类型：" required size="mini">
                    ...
                    {{ searchParams.certificateTypeId == 'normalThreeCertificate' ? '普通三证' :'多证合一' }}
                    <div class="tableMain">
                        <ul class="head">
                            <li>证件类型</li>
                            <li>证件号</li>
                        ...
                        <ul v-if="searchParams.certificateTypeId == 'normalThreeCertificate'" class="main">
                            <li  class="required">营业执照</li>
                            <li>
                                <!-- <el-input disabled v-model="searchParams.businessLicence" style="width:80%" placeholder=""></el-input> -->
                                {{ searchParams.businessLicence }}
                            </li>
                            <li>
                                <!-- <el-date-picker disabled v-model="searchParams.businessLicenceStartDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  type="date" placeholder="选择开始日期"></el-date-picker>
                                <el-date-picker disabled v-model="searchParams.businessLicenceEndDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"   type="date" placeholder="选择结束日期"></el-date-picker> -->
                                {{ searchParams.businessLicenceStartDate }} 至 {{ searchParams.businessLicenceEndDate }}
                            </li>
                            <li>
                                <div v-if="!searchParams.businessLicencePic">
                                    <!-- <el-upload name="Filedata" ref="upload1" :action="uploadUrl" :limit="1" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PBG," :before-upload="beforeUpload" :on-success="multiUploadSuccess" :on-preview="handlePreview" :on-remove="handleRemove">
                                        <el-button @click="uploadImgFlag('upload1')"  type="text" size="mini"></el-button>
                                    </el-upload> -->
                                </div>
                                <div v-else>
                        ...
                        <ul  v-if="searchParams.certificateTypeId == 'normalThreeCertificate'" class="main">
                            <li class="required">组织机构代码证</li>
                            <li>
                                <!-- <el-input disabled  v-model="searchParams.organRegistraCodeCertificate" style="width:80%" placeholder=""></el-input> -->
                                {{ searchParams.organRegistraCodeCertificate }}
                            </li>
                            <li>
                                <!-- <el-date-picker disabled v-model="searchParams.organRegistraStartDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  type="date" placeholder="选择开始日期"></el-date-picker>
                                <el-date-picker disabled v-model="searchParams.organRegistraEndDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"   type="date" placeholder="选择结束日期"></el-date-picker> -->
                                {{ searchParams.organRegistraStartDate }} 至 {{ searchParams.organRegistraEndDate }}
                            </li>
                            <li>
                                <div v-if="!searchParams.organRegistraCodeCertificatePic">
                                    <!-- <el-upload name="Filedata" ref="upload2" :action="uploadUrl" :limit="1" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PBG," :before-upload="beforeUpload" :on-success="multiUploadSuccess" :on-preview="handlePreview" :on-remove="handleRemove">
                                        <el-button @click="uploadImgFlag('upload2')"   type="text" size="mini"></el-button>
                                    </el-upload> -->
                                </div>
                                <div v-else>
                        ...
                        <ul v-if="searchParams.certificateTypeId == 'normalThreeCertificate'" class="main">
                            <li class="required">税务登记证</li>
                            <li>
                                <!-- <el-input disabled v-model="searchParams.taxRegistrationCertificate" style="width:80%" placeholder=""></el-input> -->
                                {{ searchParams.taxRegistrationCertificate }}
                            </li>
                            <li>
                                <!-- <el-date-picker disabled v-model="searchParams.taxRegistrationStartDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  type="date" placeholder="选择开始日期"></el-date-picker>
                                <el-date-picker disabled v-model="searchParams.taxRegistrationEndDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"   type="date" placeholder="选择结束日期"></el-date-picker> -->
                                {{ searchParams.taxRegistrationStartDate }} 至 {{ searchParams.taxRegistrationEndDate }}
                            </li>
                            <li>
                                <div v-if="!searchParams.taxRegistrationCertificatePic">
                                    <!-- <el-upload name="Filedata" ref="upload3" :action="uploadUrl" :limit="1" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PBG," :before-upload="beforeUpload" :on-success="multiUploadSuccess" :on-preview="handlePreview" :on-remove="handleRemove">
                        ...
                        <ul v-if="searchParams.certificateTypeId == 'multiCertificateUnion'"  class="main">
                            <li class="required">多证合一</li>
                            <li>
                                <!-- <el-input disabled v-model="searchParams.multiCertificateCombineNo" style="width:80%" placeholder=""></el-input> -->
                                {{ searchParams.multiCertificateCombineNo }}
                            </li>
                            <li>
                                <!-- <el-date-picker disabled v-model="searchParams.multiCertificateStartDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  type="date" placeholder="选择开始日期"></el-date-picker>
                                <el-date-picker disabled v-model="searchParams.multiCertificateEndDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"   type="date" placeholder="选择结束日期"></el-date-picker> -->
                                {{ searchParams.multiCertificateStartDate }} 至 {{ searchParams.multiCertificateEndDate }}
                            </li>
                            <li>
                                <div v-if="!searchParams.multiCertificateCombinePic">
                                    <!-- <el-upload name="Filedata" ref="upload4" :action="uploadUrl" :limit="1" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PBG," :before-upload="beforeUpload" :on-success="multiUploadSuccess" :on-preview="handlePreview" :on-remove="handleRemove">
                        ...
                        <ul  class="main">
                            <li class="required">法人身份证</li>
                            <li>
                                <!-- <el-input disabled @change="checkLegalPersonId" v-model="searchParams.legalPersonIdCard" style="width:80%" placeholder=""></el-input> -->
                                {{ searchParams.legalPersonIdCard }}
                            </li>
                            <li>
                                <!-- <el-date-picker disabled v-model="searchParams.idCardStartDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  type="date" placeholder="选择开始日期"></el-date-picker>
                                <el-date-picker disabled v-model="searchParams.idCardEndDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"   type="date" placeholder="选择结束日期"></el-date-picker> -->
                                {{ searchParams.idCardStartDate }} 至 {{ searchParams.idCardEndDate }}
                            </li>
                            <li>
                                <!-- <template v-if="!searchParams.legalPersonIdCardPic1">
                                    <el-upload name="Filedata" style="height:30px; line-height:30px;" ref="upload5" :action="uploadUrl" :limit="1" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PBG," :before-upload="beforeUpload" :on-success="multiUploadSuccess" :on-preview="handlePreview" :on-remove="handleRemove">
                                        <el-button @click="uploadImgFlag('upload5')"  type="text" size="mini">上传正面</el-button>
                                    </el-upload>
                                </template>
                                <template v-if="!searchParams.legalPersonIdCardPic2">
                                    <el-upload name="Filedata" style="height:30px; line-height:30px;" ref="upload6" :action="uploadUrl" :limit="1" accept=".jpg,.jpeg,.png,.JPG,.JPEG,.PBG," :before-upload="beforeUpload" :on-success="multiUploadSuccess" :on-preview="handlePreview" :on-remove="handleRemove">
                                         <el-button @click="uploadImgFlag('upload6')"  type="text" size="mini">上传反面</el-button>
                                    </el-upload>
                                </template> -->
                                <template style="height:30px">
                                    <span style="line-height:28px;" v-if="searchParams.legalPersonIdCardPic1">
                                        <a target="_blank" :href="showImg5">
                                            <img style="width:40px;" :src="showImg5" />
                                        </a>
                                        正面照片
                                    </span>
                                    <span  style="line-height:28px;" v-if="searchParams.legalPersonIdCardPic2">
            ...
            <el-row>
                <el-form-item label="备注："  size="mini">
                    <!-- <el-input style="width:500px;" type="textarea" placeholder=""> </el-input> -->
                    {{ searchParams.remark }}
                </el-form-item>
            </el-row>
            <el-row>
                <el-form-item label="状态：" required size="mini">
        ...
        <el-tabs style="margin-top:20px;" type="border-card">
            <el-tab-pane label="代理类目">
                ...
                <el-form v-else label-width="120px;">
                    <el-row :span="24">
                        <el-col :span="10">
                            <category :clear="clear"  v-on:selectResult="selectResult"></category>
                        </el-col>
                        <el-col :span="3">
                ...
                <el-table  :data="tableDataCategory" border >
                    ...
                    <!-- <el-table-column label="操作" prop="" width="100" align="center">
                        <template slot-scope="scope">
                            <el-button @click="categoryDelete(scope.$index)" type="text">删除</el-button>
                        </template>
                    </el-table-column> -->
                </el-table>
            </el-tab-pane>
            <el-tab-pane label="代理品牌">
                ...
                <el-table class="supplierTableBrand" id="supplierTableBrand"  :data="currentBrand" border >
                    ...
                    <el-table-column label="代理资质" prop=""  align="center">
                        <template slot-scope="scope">
                            <!-- <el-select disabled size="mini" v-model="scope.row.proxyAptitudeId" placeholder="请选择">
                                <el-option
                            ...
                            <span v-show="scope.row.proxyAptitudeId == 'brandSubdivision'"> 品牌方 </span>
                            <span v-show="scope.row.proxyAptitudeId == 'firstAgent'"> 一级代理 </span>
                            <span v-show="scope.row.proxyAptitudeId == 'secondAgent'"> 二级代理 </span>
                            <span v-show="scope.row.proxyAptitudeId == 'netGeneralAgent'"> 网络总代理 </span>
                            <span v-show="scope.row.proxyAptitudeId == 'others'"> 其他 </span>
                        </template>
                    </el-table-column>
                    <el-table-column label="代理有效期(开始和截止)" prop="proxyAptitudeStartDate"  align="center">
                        <template slot-scope="scope">
                            <!-- <el-date-picker disabled size="mini" v-model="scope.row.proxyAptitudeStartDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"  type="date" placeholder="选择开始日期"></el-date-picker>
                            <el-date-picker disabled size="mini" v-model="scope.row.proxyAptitudeEndDate" style="width: 45%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"   type="date" placeholder="选择结束日期"></el-date-picker> -->
                            {{ scope.row.proxyAptitudeStartDate }} 至 {{ scope.row.proxyAptitudeEndDate }}
                        </template>
                    </el-table-column>
                    <el-table-column label="资质证明" prop=""  align="center">
                        <template slot-scope="scope">
                            <!-- <el-upload
            ...
            <el-tab-pane label="财务信息">
                <el-form label-width="125px" :inline="true" size="mini">
                    <el-form-item label="开户行：" required >
                        <!-- <el-input v-model="searchParams.depositBank" style="width:250px; margin-right:30px;" placeholder=""> </el-input> -->
                        {{ searchParams.depositBank }}
                    </el-form-item>
                    <el-form-item label="银行账号：" required >
                        <!-- <el-input v-model="searchParams.bankAccount" style="width:250px;" placeholder=""> </el-input> -->
            ...
            <el-tab-pane label="售后信息">
                <el-form label-width="125px" size="mini">
                    <el-form-item label="退货省市区：" required >
                        {{ returnProvince_city_area[0] }}-{{ returnProvince_city_area[1] }}-{{ returnProvince_city_area[2] }}
                    </el-form-item>
                    <el-form-item label="退货地址：" required >
                        <!-- <el-input v-model="searchParams.goodsReturnAddress"  style="width:250px;" placeholder=""> </el-input> -->
                        {{ searchParams.goodsReturnAddress }}
                    </el-form-item>
                    <el-form-item label="退货联系人：" required >
                        <!-- <el-input v-model="searchParams.goodsReturnContactPerson" style="width:250px;" placeholder=""> </el-input> -->
                        {{ searchParams.goodsReturnContactPerson }}
                    </el-form-item>
                    <el-form-item label="退货联系电话：" required >
                        <!-- <el-input @change="checkPhone('goodsReturnPhone')" v-model="searchParams.goodsReturnPhone" style="width:250px;" placeholder=""> </el-input> -->
                        {{ searchParams.goodsReturnPhone }}
                    </el-form-item>
                    <el-form-item label="退货策略："  >
                        <!-- <el-input v-model="searchParams.goodsReturnStrategy" type="textarea" style="width:500px;" placeholder=""> </el-input> -->
                        {{ searchParams.goodsReturnStrategy }}
                    </el-form-item>
                </el-form>
            </el-tab-pane>
        </el-tabs>
        ...
        <div style="text-align: center; padding: 20px 0;">
            <el-button @click="toSupplierRedit"  size="mini" type="primary">编辑</el-button>
    ...
    methods: {
        ...
        toSupplierRedit() {
            this.$router.push({
                ...
                params: {
                    id: this.searchParams.supplierCode
                }
            });
        },
        // 关闭选择品牌弹窗
        ...
        checkPhone(row) {
            ...
            if (!regexp.test(this.searchParams[row])) {
                this.searchParams[row] = '';
                this.$utils.messagetip.warningTip('手机号码格式错误,请重新填写');
            }
        },
        // 校验身份证号
        checkLegalPersonId() {
            ...
            if (!reg.test(this.searchParams.legalPersonIdCard)) {
                this.$utils.messagetip.warningTip('法人身份证号格式错误,请重新填写');
        ...
        initSupplierData() {
            this.$AXIOS.GET('/supplier/supplier/' + this.supperlierCode).then(res => {
                ...
                let citys = window.localStorage.city ? JSON.parse(window.localStorage.city) : '';
                if (res.result.supplier.supplierTypeCode === 'internalSupplier') {
                    citys.map(item => {
                        if (item.id === res.result.supplier.province ) {
                            this.province_city_area[0] = item.text;
                        }
                        item.children.map(item1 => {
                            if (item1.id === res.result.supplier.city) {
                                this.province_city_area[1] = item1.text;
                            }
                            item1.children.map(item2 => {
                                if (item2.id === res.result.supplier.area) {
                                    this.province_city_area[2] = item2.text;
                                }
                            });
                        });
                    });
                } else if (res.result.supplier.supplierTypeCode === 'overseasSupplier') {
                    this.initCountry(res.result.supplier.country);
                }

                citys.map(item => {
                    if (item.id === res.result.supplierAfterSaleInfo.saleProvince ) {
                        this.returnProvince_city_area[0] = item.text;
                    }
                    item.children.map(item1 => {
                        if (item1.id === res.result.supplierAfterSaleInfo.saleCity) {
                            this.returnProvince_city_area[1] = item1.text;
                        }
                        item1.children.map(item2 => {
                            if (item2.id === res.result.supplierAfterSaleInfo.saleArea) {
                                this.returnProvince_city_area[2] = item2.text;
                            }
                        });
                    });
                });
        ...
        checkSupplierData() {
            ...
            if (!this.currentBrand.length) {
                this.$utils.messagetip.warningTip('供应商代理品牌不能为空');
                return false;
            } else {
                ...
                for (let i = 0; i < this.currentBrand.length; i++) {
                    if (!this.currentBrand[i].proxyAptitudeId) {
                        index = i;
                        num = 0;
                        this.$utils.messagetip.warningTip('代理资质不能为空');
                        break;
                    }
                    if (!this.currentBrand[i].proxyAptitudeStartDate ) {
                        index = i;
                        num = 1;
                        this.$utils.messagetip.warningTip('资质有效时间不能为空');
                        break;
                    }
                    ...
                    if (!this.currentBrand[i].pictureArr.length) {
                        index = i;
                        num = 5;
                        this.$utils.messagetip.warningTip('资质图片不能为空');
                        break;
                    }
                }
                if (index > -1) {
            ...
            if (!this.searchParams.depositBank || !this.searchParams.bankAccount) {
                this.$utils.messagetip.warningTip('请补充完财务信息再保存');
                return false;
            }
            if (!this.searchParams.saleProvince || !this.searchParams.goodsReturnAddress || !this.searchParams.goodsReturnContactPerson || !this.searchParams.goodsReturnPhone) {
                this.$utils.messagetip.warningTip('请补充完售后信息再保存');
                return false;
            }
            return true;
        },
        ...
        // 添加品牌
        addBrand(flag) {
            if (flag) this.searchBrandNmae = '';
            let arr = [];
            this.tableDataCategory.map(item => {
                arr.push(item.categoryId);
            });
            if (!arr.length) {
                this.$utils.messagetip.warningTip('请先添加供应商代理分类!');
            } else {
                this.tableDataBrand = [];
        ...
        confirmAddCategory() {
            for (let i = 0; i < this.currentCategory.length; i++) {
                this.$AXIOS.GET('/supplier/checkCategoryBrandValidStatus/' + this.currentCategory[i].categoryId).then(res => {
                    let flag = true;
                    for (let i = 0; i < this.tableDataCategory.length; i++) {
                        if (this.tableDataCategory[i].categoryId === this.currentCategory.categoryId) {
                            flag = false;
                            break;
                        }
                    }
                    if (flag) {
                        this.tableDataCategory.push(this.currentCategory[i]);
                        this.clear = true;
                        setTimeout(() => {
                            this.clear = false;
                        ...
                        this.$utils.messagetip.warningTip('该分类已存在');
                        this.currentCategory = '';
                        // this.clear = true;
                    }
                });
        ...
        multiUploadSuccess(res) {
            this.$refs[this.uploadFlag].clearFiles();
            if (this.uploadFlag === 'upload1') {
                this.searchParams.businessLicencePic = res.key;
                this.showImg1 = res.url;
            } else if (this.uploadFlag === 'upload2') {
                this.searchParams.organRegistraCodeCertificatePic = res.key;
                this.showImg2 = res.url;
            } else if (this.uploadFlag === 'upload3') {
                this.searchParams.taxRegistrationCertificatePic = res.key;
                this.showImg3 = res.url;
            } else if (this.uploadFlag === 'upload4') {
                this.searchParams.multiCertificateCombinePic = res.key;
                this.showImg4 = res.url;
            } else if (this.uploadFlag === 'upload5') {
                this.searchParams.legalPersonIdCardPic1 = res.key;
                this.showImg5 = res.url;
            } else if (this.uploadFlag === 'upload6') {
                this.searchParams.legalPersonIdCardPic2 = res.key;
                this.showImg6 = res.url;
            }
        },
        uploadImgFlag(str) {
            this.uploadFlag = str;
        ...
        brandUploadSuccess(res, index) {
            for (let i = 0; i < this.currentBrand.length; i++) {
                if (i === this.tableImgCurrent) {
                    this.currentBrand[i].pictureArr.push({ key: res.key, url: res.url });
                }
            }
        ...
        initCountry(code) {
            this.$AXIOS.GET('/select/country').then(res => {
                res.result.map(item => {
                    if (item.value === code) {
                        this.province_city_area = item.name;
                    }
                });
            });
        },
