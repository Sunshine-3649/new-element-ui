        ...
        <el-form style="margin-top:20px"  label-width="125px" ref="queryForm" size="medium">
            ...
            <el-row>
                <el-form-item label="联系人电话：" required size="mini">
                    <el-input maxlength="16" @change="checkPhone('phone')" v-model="searchParams.phone" style="width:250px;" placeholder=""> </el-input>
                </el-form-item>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-form-item v-if="searchParams.supplierTypeCode == 'internalSupplier'" label="证件类型：" :required="searchParams.supplierKindCode == 'purchase'" size="mini">
                    ...
                    <div class="tableMain">
                        <ul class="head">
                            <li><span class="required">证件类型</span></li>
                            <li><span class="required">证件号</span></li>
                            <li><span class="required">证件有效期</span></li>
                            <li><span class="required">证件图片</span></li>
                        </ul>
    ...
    methods: {
        ...
        keepSupplierData() {
            if (this.checkSupplierData()) {
                ...
                this.$AXIOS.POST('/supplier/supplier', data).then(res => {
        ...
        checkSupplierData() {
            ...
            if (this.searchParams.supplierTypeCode === 'internalSupplier' && this.searchParams.supplierKindCode === 'purchase') {
                if (this.searchParams.certificateTypeId === 'normalThreeCertificate' ) {
